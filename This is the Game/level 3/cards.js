...
var img_arr = ['imgs/pic2.png','imgs/pic4.png', 'imgs/pic5.jpg', 'imgs/pic6.png', 'imgs/pic7.jpg', 'imgs/pic8.png','imgs/pic2.png','imgs/pic4.png', 'imgs/pic5.jpg', 'imgs/pic6.png', 'imgs/pic7.jpg', 'imgs/pic8.png'];

var hearts = ['hearts.png', 'hearts1.png', 'hearts2.png','hearts3.png'];
var card =['card1','card2','card3','card4','card5','card6','card7','card8','card9','card10','card11','card12']
                    ...
                    if (viewed == 2) {
                        var delay_fun = function () {
                            if (first_src == src) {
                                ...
                                points_par.innerText =points;
                                //local storage
                                if (localStorage.getItem("max_points3") < points) 
                                    {
                                    localStorage.setItem("max_points3", points)
                                    }
                                document.getElementById("bestscore").innerText ="Best Score is : " +localStorage.getItem("max_points3")
                                //level complete
...
var obj_arr = {obj1 : c1,obj2 : c2,obj3 : c3,obj4 : c4,obj5 : c5,obj6 : c6,obj7 : c7,obj8 : c8,obj9 : c9,obj10 : c10,obj11 : c11,obj12 : c12}
