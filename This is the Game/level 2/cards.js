...
var first_id = "";
var points = 0;
var maxscore = localStorage.getItem("max_points2");
var heartslost=0;
...
var img_arr = ['imgs/pic4.png', 'imgs/pic4.png', 'imgs/pic9.jpg', 'imgs/pic9.jpg', 'imgs/pic3.jpg', 'imgs/pic3.jpg'];
                    ...
                    if (viewed == 2) {
                        var delay_fun = function () {
                            if (first_src == src) {
                                ...
                                document.getElementById("bestscore").innerText ="Best Score is : " +localStorage.getItem("max_points2")
                                //level complete
