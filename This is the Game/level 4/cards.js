                    ...
                    if (viewed == 2) {
                        var delay_fun = function () {
                            if (first_src == src) {
                                ...
                                points_par.innerText =points;
                                //local storage
                                if (localStorage.getItem("max_points4") < points) 
                                    {
                                    localStorage.setItem("max_points4", points)
                                    }
                                document.getElementById("bestscore").innerText ="Best Score is : " +localStorage.getItem("max_points4")
                                //level complete
